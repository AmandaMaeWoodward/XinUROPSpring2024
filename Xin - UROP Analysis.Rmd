...
```{r}
#box plot for metacognitive reflection score change across three case studies
mr_data <- data.frame(
...
#Anova analysis? 
#overall confidence change in three case study
```{r}
data_long <- data.frame(
  Participant = rep(clean_data$participant, times = 3),
...
##confidence level change acoress three case study
```{r}
